...
def plot_color_map(fig, ax, res, bounds_x, bounds_y, p, S, sigma):
...
if __name__ == "__main__":
  ...
  plot_color_map(cmap_fig1, cmap_ax1, 1000, [-5, 5], [-5, 5], p, S0, 10)
  ...
  plot_color_map(cmap_fig, cmap_ax, 1000, [-5, 5], [-5, 5], p, S, sigma=1)
